...
| `ephproto/v4/` | Astrolog's ephemeris protocol **version 4** (`ephproto.h`, the byte-level authority prometheiad speaks) + its generated `registries.json` | Astrolog `qt` commit `114f2a5`, the floats drop (header sha256 `ddfb121f…`; unchanged at `61759f4`); `registries.json` unchanged since `eed6429` (`84104b8b…`) | GPL-2.0 (Astrolog, `license.htm` in its tree) | the floats drop: DATA values finite or the canonical NaN, a failed row NaN in every column, `0x7FC00000` the canonical NaN at f32 (found by Prometheia's codec fuzzer, docs/SERVER.md "Fuzzing"). Verified 2026-09-18: set-sha256 `cdbd7438570f29ce6ec1d947e7a4210cd3931f413c653801033f14a42df5aef6` over the 105 conformance fixtures, 105/105 through the vendored codec and 105/105 through the independent reader (`tools/check/ephproto4_fixtures.py`, taught the rule from the spec text), `JUDGEMENTS.tsv` 7/7. Previously ephv4 `eed6429` (set `d904e358…`, 99/99), and before it `0fbc863` (set `1c934c7d…`, 91/91) |
| `nlohmann/json.hpp` | JSON for Modern C++ (Niels Lohmann), the single header: the JSON and MCP tools only (`prometheia_json`), never `prometheiad` or the engine | release v3.11.3, `https://github.com/nlohmann/json/releases/download/v3.11.3/json.hpp`, sha256 `9bea4c8066ef4a1c206b2be5a36302f8926f7fdc6087af5d20b417d0cf103ea6` | MIT | unmodified |
