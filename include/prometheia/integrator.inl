...
constexpr double kB5[7] = {35.0 / 384.0, 0.0, 500.0 / 1113.0, 125.0 / 192.0, -2187.0 / 6784.0,
                           11.0 / 84.0,  0.0};

// 4th-order embedded solution (for the error estimate).
constexpr double kB4[7] = {
...
Result<void> integrate_dp54(double* y, double t0, double t1, Force&& accel,
                            const IntegrateOptions& opts, IntegrateStats* stats, Sink&& sink) {
    if (t1 == t0)
        return {};
