...
void emit(std::FILE* out, const char* program, const char* fmt, va_list ap) {
    ...
    gmtime_r(&secs, &tm);
    char line[1024];
    int n = std::snprintf(line, sizeof(line), "%s %04d-%02d-%02dT%02d:%02d:%02d.%03ldZ ", program,
